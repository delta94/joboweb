    ...
    $scope.pagingSchedules = function (newfilter, p) {
      ...
      $http({
        ...
        $timeout(function () {
          ...
          console.log('Schedules', $scope.response, params, response.data)
          $scope.schedules = Object.keys(response.data).map(key => response.data[key]);
